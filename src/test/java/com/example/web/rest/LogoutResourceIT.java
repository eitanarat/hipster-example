...
import com.example.DemoprojApp;
...
import static com.example.web.rest.TestUtil.ID_TOKEN;
import static com.example.web.rest.TestUtil.authenticationToken;
 ...
 */
@SpringBootTest(classes = {DemoprojApp.class, TestSecurityConfiguration.class})
